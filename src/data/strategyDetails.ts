...
export const strategyDetails: Record<string, StrategyDetail> = {
  ...
  "EST-019": {
    id: "EST-019",
    problema_resuelve: "Actividades poco alineadas al nivel cognitivo",
    cuando_usarla: "Diseño o rediseño de sesión",
    herramientas_ia: [],
    herramientas_detalle: {},
    prompt_base: "Diseña 3 actividades sobre [tema] variando nivel cognitivo",
    pasos: ["Definir objetivo", "Elegir niveles cognitivos", "Generar actividades", "Ajustar dificultad"],
    donde_entra_ia: [],
    evidencia: "Secuencia de actividades por nivel",
